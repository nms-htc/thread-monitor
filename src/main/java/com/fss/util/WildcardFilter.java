...
/**
 * <p>Title: WildcardFilter</p>
 * <p>Description: Implements for wildcard filter</p>
...
public class WildcardFilter implements FilenameFilter
{
	 ...
	 * @param strWildcard original wildcard of WildcardFilter
	 */
	////////////////////////////////////////////////////////
	 ...
	 * @param strWild wildcard to compare
	 * @param strVal value to compare
	 ...
	 * @param strWild wildcard to compare
	 * @param strVal value to compare
	 * @param bIgnoreCase true you dont want to compare case otherwise false
	 * @return true if value match wildcard otherwise false
	 */
	////////////////////////////////////////////////////////
	public static boolean match(String strWild,String strVal,boolean bIgnoreCase)
	{
		...
		while((iVal < iValCount) && (iWild < iWildCount))
		{
			...
			{
				iWild++;
				if(iWild >= iWildCount) return true;
				while(true)
				{
