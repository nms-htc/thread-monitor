...
/**
 * <p>
 * Title: Listen from socket </p>
 * <p>
 * Description: - Always listen from socket - Data which it's read then is passed to 2 queue:
...
public class SocketTransmitter implements Runnable, Transmitter {
    ...
    /**
     * always add ddtp from socket to two queues: Vector mvtRequest or Vector mvtResponse
     *
     * @author - HiepTH - TrungDD
     */
    ////////////////////////////////////////////////////////////
    public void run() {
        try {
     ...
     * @return request data Author: TrungDD
     */
    ////////////////////////////////////////////////////////////
     ...
     * @return response data Author: TrungDD
     */
    ////////////////////////////////////////////////////////////
