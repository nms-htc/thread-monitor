...
import com.nms.tm.model.ConnectionsTreeModel;
...
public class ThreadMonitor extends javax.swing.JFrame {
    ...
    private static final long serialVersionUID = -3168369672403537626L;
    ...
    private void initComponents() {
        ...
        serverTree.setModel(getConnectionsTreeModel());
    ...
    public ConnectionsTreeModel getConnectionsTreeModel() {
        if (connectionsTreeModel == null) {
            connectionsTreeModel = new ConnectionsTreeModel();
        }
        return connectionsTreeModel;
    }
}
